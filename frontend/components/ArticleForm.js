...
export default function ArticleForm({ currentArticle, updateArticle, postArticle, setCurrentArticle }) {
    ...
    const cancelEdit = () => {
        // We should reset the form back to initial values
        // and call the `setCurrentArticle` prop with no arguments.
        setValues(initialFormValues);
        setCurrentArticle();
    };
